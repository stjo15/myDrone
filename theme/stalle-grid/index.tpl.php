...
<?php if ($this->views->hasContent('lsidebar')) : ?>
<div id='lsidebar'><?php $this->views->render('lsidebar')?></div>
<?php endif; ?>
...
<?php if ($this->views->hasContent('rsidebar')) : ?>
<div id='rsidebar'><?php $this->views->render('rsidebar')?></div>
<?php endif; ?>

<?php if ($this->views->hasContent('triptych-1', 'triptych-2')) : ?>
...
<?php if ($this->views->hasContent('footer-column-1', 'footer-column-2', 'footer-column-3')) : ?>
<div id='wrap-footer-column'>
    <div id='footer-column-1'><?php $this->views->render('footer-column-1')?></div>
    <div id='footer-column-2'><?php $this->views->render('footer-column-2')?></div>
    <div id='footer-column-3'><?php $this->views->render('footer-column-3')?></div>
    <div id='footer-column-4'><?php $this->views->render('footer-column-4')?></div>
</div>
<?php endif; ?>
