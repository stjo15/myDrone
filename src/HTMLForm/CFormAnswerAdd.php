...
class CFormAnswerAdd extends \Mos\HTMLForm\CForm
{
    ...
    public function callbackSubmit()
    {
        ...
        $saved = $this->newanswer->save(array('title' => $title, 'content' => $this->Value('content'), 'mail' => $email, 'name' => $name, 'userid' => $userid, 'web' => $web, 'pagekey' => $this->pagekey, 'timestamp' => $now, 'ip' => $this->di->request->getServer('REMOTE_ADDR'), 'gravatar' => 'http://www.gravatar.com/avatar/' . md5(strtolower(trim($email))) . '.jpg'));
