...
class CDatabaseModel implements \Anax\DI\IInjectionAware
{
    ...
    */
    ...
    /**
    * Update with custom table and where clause.
    *
    ...
    * @return boolean true or false if saving went okey.
    */
    public function customUpdate($table, $values, $where)
    {
        $keys   = array_keys($values);
        $values = array_values($values);
    ...
    */
    ...
    /**
    * Build the SQL 'and where' part.
    *
    * @param string $condition for building the 'and where' part of the query.
    *
    * @return $this
    */
